...
BEGIN_MESSAGE_MAP(CMy02MenuView, CView)
	...
	ON_COMMAND(ID_FILE_PRINT_PREVIEW, &CMy02MenuView::OnFilePrintPreview)
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
END_MESSAGE_MAP()
...
void CMy02MenuView::OnFilePrintPreview()
{
#ifndef SHARED_HANDLERS
...
void CMy02MenuView::OnRButtonUp(UINT /* nFlags */, CPoint point)
{
	ClientToScreen(&point);
	OnContextMenu(this, point);
}

void CMy02MenuView::OnContextMenu(CWnd* /* pWnd */, CPoint point)
{
#ifndef SHARED_HANDLERS
